...
class VentaPGController extends Controller
{
    ...
    {
        $pyg = PerdidaGanancia::with([
            'detalles',
        ])->where('credito_id', $request->credito_id)->get();
        return $pyg;
    }
    public function update(UpdatePerdidasGananciasRequest $request)
    {
        ...
        $pyg = PerdidaGanancia::where('credito_id',$request->credito_id)->first();
