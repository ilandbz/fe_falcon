<script setup>
  ...
  import usePrecioServicio from '@/Composables/PrecioServicio.js';
  import JsonExcel from 'vue-json-excel3';
  import html2canvas from 'html2canvas'
  import jspdf from 'jspdf'
  const { formatoFecha, meses } = useHelper();

    const { registros, obtenerServicios,errors } = usePrecioServicio();
    ...
    const listarServicio = async(page=1) => {
        ...
        await obtenerServicios(dato.value, periodo.value.codigo)
    }
      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h6 class="card-title">
                    Precios de Servicios por Periodo
                </h6>
            </div>
            <div class="card-body">
                <div class="row mb-4">
