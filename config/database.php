...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'local_db' => [
            'driver' => 'mysql',
            'host' => env('DB_LOCAL_HOST', '192.168.14.121'),
            'port' => env('DB_LOCAL_PORT', '13306'),
            'database' => env('DB_LOCAL_DATABASE', 'openclinic_dbo'),
            'username' => env('DB_LOCAL_USERNAME', 'cristian'),
            'password' => env('DB_LOCAL_PASSWORD', '123456'),
        ...
        'local_db_maestros' => [
            ...
            'host' => env('DB_LOCAL_HOST', '192.168.14.121'),
            'port' => env('DB_LOCAL_PORT', '13306'),
            'database' => env('DB_LOCAL_DATABASE', 'bdsis_maestros'),
            'username' => env('DB_LOCAL_USERNAME', 'cristian'),
            'password' => env('DB_LOCAL_PASSWORD', '123456'),
            'unix_socket' => env('DB_LOCAL_SOCKET', ''),
            'charset' => 'utf8mb4',
